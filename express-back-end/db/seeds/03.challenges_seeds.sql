...
INSERT INTO daily_challenges (step_goal, water_goal, active_min_goal, coins, completed, is_active, user_id, created_date) VALUES (6000, 8, 10, 300, TRUE, FALSE, 3, '2021-05-05');
INSERT INTO daily_challenges (step_goal, water_goal, active_min_goal, coins, completed, is_active, user_id, created_date) VALUES (8000, 8, 20, 300, TRUE, FALSE, 2, '2021-05-05');
INSERT INTO daily_challenges (step_goal, water_goal, active_min_goal, coins, completed, is_active, user_id,created_date) VALUES (10000, 8, 30, 300, FALSE, TRUE, 1, '2021-05-05');
